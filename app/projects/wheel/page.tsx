    ...
    <div>
      <ProjectHero
        ...
        results={[
          ...
          {
            title: "More first assignment completions under round robin system",
          },
          {
      ...
      >
        <ProjectSectionContent
          headline={
            <>
              Clinicians used email to know what patients they were assigned to,
              needed to context switch and learn many different platforms
            </>
          }
          body={
            <>
      ...
      >
        ...
        />
        <Quote
          image="/images/bf-leadership/?.webp"
          name="N/A"
          role="N/A"
          preview={
            <>
        ...
        <Quote
          ...
          preview={
            <>
              Can I make a confession? I wake up at 2-3 in the morning and do
              [assignments].
            </>
          }
          fullQuote={<></>}
